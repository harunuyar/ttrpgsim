...
public class SuccessRollEvent : AEvent, ISuccessRollEvent
{
    public SuccessRollEvent(string name, IGameActor eventOwner, ISuccessRollAction action, int? targetResult, IGameActor? opponent) 
