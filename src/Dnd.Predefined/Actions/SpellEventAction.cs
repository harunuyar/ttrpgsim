...
public abstract class SpellEventAction : EventAction, ISpellAction
{
    public SpellEventAction(ISpellcastingAbility spellcastingAbility, SpellModel spellModel, int spellSlot, IEnumerable<IActionUsageLimit> usageLimits)
